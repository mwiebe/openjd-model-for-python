...
class TestLogical:
    ...
    def test_or_empty_list_is_truthy(self) -> None:
        assert evaluate_expression("[] or [1]").to_string() == "[]"
...
class TestCrossTypeOrderingErrors:
    ...
    def test_string_lt_int_errors(self) -> None:
        ...
        with pytest.raises(ExpressionTypeError, match="Cannot compare string with int"):
    ...
    def test_bool_lt_int_errors(self) -> None:
        ...
        with pytest.raises(ExpressionTypeError, match="Cannot compare bool with int"):
    ...
    def test_int_lt_string_errors(self) -> None:
        ...
        with pytest.raises(ExpressionTypeError, match="Cannot compare int with string"):
            evaluate_expression('5 < "5"')

    def test_float_gt_string_errors(self) -> None:
        from openjd.expr import ExpressionTypeError

        with pytest.raises(ExpressionTypeError, match="Cannot compare float with string"):
