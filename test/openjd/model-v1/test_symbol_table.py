...
class TestSymbolTable:
    ...
    def test_copy_construct_from_symtab(self):
        ...
        assert result["Test.Symtab1"].item() == "One"
        assert result["Test.Symtab2"].item() == 1
    ...
    def test_union(self):
        ...
        assert result["Test.Symtab1"].item() == "One"
        assert result["Test.Symtab2"].item() == "Two"
        assert result["Overlap1"].item() == 2, "Later arguments win duplicates"
        assert result["Overlap2"].item() == 2
    ...
    def test_union_multiple(self):
        ...
        assert result["Test.Symtab1"].item() == "One"
        assert result["Test.Symtab2"].item() == "Two"
        assert result["Test.Symtab3"].item() == "Three"
        assert result["Overlap1"].item() == 2, "Later arguments win duplicates"
        assert result["Overlap2"].item() == 3, "Later arguments win duplicates"
