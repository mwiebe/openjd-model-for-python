...
from openjd.model._v1.v2023_09 import JobTemplate, ModelParsingContext as ModelParsingContext_v2023_09
...
def test_job_template_variables_parse_success(data: dict[str, Any]) -> None:
    ...
    # WHEN
    _parse_model(model=JobTemplate, obj=data, context=ModelParsingContext_v2023_09())
    ...
    pytest.param(
        {
            ...
            "steps": [
                ...
                {
                    "name": "BarStep",
                    "script": make_script("Task", "BarScript", "echo {{Task.File.BazScript}}"),
                },
                {
                    "name": "BazStep",
                    "script": make_script("Task", "BazScript", "echo {{Task.File.BarScript}}"),
                },
            ],
        },
        2,
    ...
    pytest.param(
        {
            ...
            "jobEnvironments": [
                ...
                {
                    "name": "BarEnv",
                    "script": make_script("Env", "BarScript", "echo {{Env.File.BazScript}}"),
                },
                {
                    "name": "BazEnv",
                    "script": make_script("Env", "BazScript", "echo {{Env.File.BarScript}}"),
                },
            ],
        },
        2,
    ...
    pytest.param(
        {
            ...
            "jobEnvironments": [
                {
                    "name": "BarEnv",
                    "script": make_script("Env", "BarScript", "echo {{Env.File.BarScript}}"),
                },
            ],
            "steps": [
                {
...
def test_job_template_variables_parse_fails(data: dict[str, Any], error_count: int) -> None:
