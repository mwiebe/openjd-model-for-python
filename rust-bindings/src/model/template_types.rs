...
#[pyclass(module = "openjd.model._v1.template", name = "TemplateAction", from_py_object)]
#[derive(Clone)]
...
impl PyAction {
    ...
    fn command(&self) -> PyFormatString {
        PyFormatString { inner: self.inner.command.clone() }
    }
    ...
    fn args(&self) -> Option<Vec<PyFormatString>> {
        self.inner
            .args
            .as_ref()
            .map(|a| a.iter().map(|fs| PyFormatString { inner: fs.clone() }).collect())
    }

    #[getter]
    fn timeout(&self) -> Option<PyFormatString> {
        self.inner.timeout.as_ref().map(|t| PyFormatString { inner: t.clone() })
    }

    #[getter]
    fn cancelation(&self) -> Option<PyCancelationMode> {
        self.inner.cancelation.as_ref().map(|c| PyCancelationMode { inner: c.clone() })
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateCancelationMode", from_py_object)]
#[derive(Clone)]
...
impl PyCancelationMode {
    ...
    fn notify_period_in_seconds(&self) -> Option<PyFormatString> {
        match &self.inner {
            ...
            CancelationMode::NotifyThenTerminate { notify_period_in_seconds } => {
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateStepActions", from_py_object)]
#[derive(Clone)]
...
impl PyStepActions {
    ...
    fn new(on_run: PyAction) -> Self {
        PyStepActions { inner: StepActions { on_run: on_run.inner } }
    }

    #[getter]
    fn on_run(&self) -> PyAction {
        PyAction { inner: self.inner.on_run.clone() }
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateEnvironmentActions", from_py_object)]
#[derive(Clone)]
...
impl PyEnvironmentActions {
    ...
    fn on_enter(&self) -> Option<PyAction> {
        self.inner.on_enter.as_ref().map(|a| PyAction { inner: a.clone() })
    }
    ...
    fn on_exit(&self) -> Option<PyAction> {
        self.inner.on_exit.as_ref().map(|a| PyAction { inner: a.clone() })
    }
    ...
    fn __repr__(&self) -> String {
        format!(
            ...
            self.on_enter().map(|a| a.__repr__()).unwrap_or_else(|| "None".to_string()),
            self.on_exit().map(|a| a.__repr__()).unwrap_or_else(|| "None".to_string()),
        )
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateEmbeddedFile", from_py_object)]
#[derive(Clone)]
...
impl PyEmbeddedFile {
    ...
    fn filename(&self) -> Option<PyFormatString> {
        self.inner.filename.as_ref().map(|fs| PyFormatString { inner: fs.clone() })
    }

    #[getter]
    fn data(&self) -> Option<PyFormatString> {
        self.inner.data.as_ref().map(|fs| PyFormatString { inner: fs.clone() })
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateStepScript", from_py_object)]
#[derive(Clone)]
...
impl PyStepScript {
        ...
        PyStepScript {
            inner: StepScript {
                ...
                embedded_files: embedded_files
                    .map(|v| v.into_iter().map(|f| f.inner).collect()),
            },
        }
    }
    ...
    fn actions(&self) -> PyStepActions {
        PyStepActions { inner: self.inner.actions.clone() }
    }
    ...
    fn embedded_files(&self) -> Option<Vec<PyEmbeddedFile>> {
        self.inner
            .embedded_files
            .as_ref()
            .map(|v| v.iter().map(|f| PyEmbeddedFile { inner: f.clone() }).collect())
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateEnvironmentScript", from_py_object)]
#[derive(Clone)]
...
impl PyEnvironmentScript {
    ...
    fn actions(&self) -> PyEnvironmentActions {
        PyEnvironmentActions { inner: self.inner.actions.clone() }
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateEnvironment", from_py_object)]
#[derive(Clone)]
...
impl PyEnvironment {
    ...
    fn script(&self) -> Option<PyEnvironmentScript> {
        self.inner.script.as_ref().map(|s| PyEnvironmentScript { inner: s.clone() })
    }
...
impl PyAmountRequirement {
    ...
    fn min(&self) -> Option<PyFormatString> {
        self.inner.min.as_ref().map(|fs| PyFormatString { inner: fs.clone() })
    }

    #[getter]
    fn max(&self) -> Option<PyFormatString> {
        self.inner.max.as_ref().map(|fs| PyFormatString { inner: fs.clone() })
    }
...
impl PyAttributeRequirement {
    ...
    fn any_of(&self) -> Option<Vec<PyFormatString>> {
        self.inner
            .any_of
            .as_ref()
            .map(|v| v.iter().map(|fs| PyFormatString { inner: fs.clone() }).collect())
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "TemplateStepDependency", from_py_object)]
#[derive(Clone)]
...
impl PyStepDependency {
    ...
    fn new(depends_on: String) -> Self {
        PyStepDependency { inner: StepDependency { depends_on } }
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "SimpleAction", from_py_object)]
#[derive(Clone)]
...
impl PySimpleAction {
    ...
    #[getter]
    fn timeout(&self) -> Option<PyFormatString> {
        self.inner.timeout.as_ref().map(|fs| PyFormatString { inner: fs.clone() })
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "StepTemplate", from_py_object)]
#[derive(Clone)]
...
impl PyStepTemplate {
    ...
    fn dependencies(&self) -> Option<Vec<PyStepDependency>> {
        self.inner
            .dependencies
            .as_ref()
            .map(|v| v.iter().map(|d| PyStepDependency { inner: d.clone() }).collect())
    }
    ...
    fn step_environments(&self) -> Option<Vec<PyEnvironment>> {
        self.inner
            .step_environments
            .as_ref()
            .map(|v| v.iter().map(|e| PyEnvironment { inner: e.clone() }).collect())
    }
    ...
    fn script(&self) -> Option<PyStepScript> {
        self.inner.script.as_ref().map(|s| PyStepScript { inner: s.clone() })
    }

    #[getter]
    fn bash(&self) -> Option<PySimpleAction> {
        self.inner.bash.as_ref().map(|s| PySimpleAction { inner: s.clone() })
    }

    #[getter]
    fn python(&self) -> Option<PySimpleAction> {
        self.inner.python.as_ref().map(|s| PySimpleAction { inner: s.clone() })
    }

    #[getter]
    fn cmd(&self) -> Option<PySimpleAction> {
        self.inner.cmd.as_ref().map(|s| PySimpleAction { inner: s.clone() })
    }

    #[getter]
    fn powershell(&self) -> Option<PySimpleAction> {
        self.inner.powershell.as_ref().map(|s| PySimpleAction { inner: s.clone() })
    }

    #[getter]
    fn node(&self) -> Option<PySimpleAction> {
        self.inner.node.as_ref().map(|s| PySimpleAction { inner: s.clone() })
    }
