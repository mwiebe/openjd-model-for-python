...
use openjd_model::template::{
    BoolUserInterface, FileFilter, FloatUserInterface, HiddenOnlyUserInterface,
    IntUserInterface, ListFloatUserInterface, ListIntUserInterface, ListPathUserInterface,
    ListSimpleUserInterface, PathUserInterface, RangeExprUserInterface, StringUserInterface,
};

// ── FileFilter ──

#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model._v1.template", name = "FileFilter", from_py_object)]
#[derive(Clone)]
