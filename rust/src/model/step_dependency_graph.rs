...
#[pyclass(module = "openjd.model.v1", name = "StepDependencyGraph")]
...
impl PyStepDependencyGraph {
    fn make_node(&self, node_index: usize) -> PyStepDependencyNode {
        ...
        PyStepDependencyNode {
            step: PyStep { inner: self.job_steps[node.step_index].clone() },
            in_edges,
            out_edges,
        }
    }
...
impl PyStepDependencyGraph {
    ...
    fn topo_sorted(&self) -> PyResult<Vec<PyStep>> {
        ...
        Ok(indices
            .into_iter()
            .map(|i| PyStep { inner: self.job_steps[i].clone() })
            .collect())
    }
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model.v1", name = "StepDependencyNode")]
#[derive(Clone)]
...
#[cfg_attr(feature = "stub-gen", gen_stub_pyclass(module = "openjd._openjd_rs"))]
#[pyclass(module = "openjd.model.v1", name = "StepDependencyEdge")]
#[derive(Clone)]
...
impl PyStepDependencyEdge {
    ...
    fn origin(&self) -> PyStepDependencyNode {
        PyStepDependencyNode {
            step: PyStep { inner: self.origin_step.clone() },
            in_edges: vec![],
            out_edges: vec![],
        }
    }
    ...
    fn dependent(&self) -> PyStepDependencyNode {
        PyStepDependencyNode {
            step: PyStep { inner: self.dependent_step.clone() },
            in_edges: vec![],
            out_edges: vec![],
        }
    }
