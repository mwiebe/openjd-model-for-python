...
def validate_int_fmtstring_field(
    value: Union[int, float, Decimal, str, FormatString], ge: Optional[int] = None, *, context: Optional[ModelParsingContextInterface]
...
def validate_float_fmtstring_field(
    value: Union[int, float, Decimal, str, FormatString], ge: Optional[Decimal] = None, *, context: Optional[ModelParsingContextInterface]
) -> Union[int, float, Decimal, FormatString]:
...
def validate_list_field(value: list, validator: Callable, *, context: Optional[ModelParsingContextInterface]) -> list:
